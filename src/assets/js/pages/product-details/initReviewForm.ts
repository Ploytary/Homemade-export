...
import phpHandler from '../../../php/reviews-form-handler.php';
...
export function initReviewForm() {
  try {
    const validator = new JustValidate('.review-form', config, dictLocale);
    ...
    validator
      .addField('.review-form .input-field__input[name="name"]', [
        {
          rule: Rules.Required,
      ...
      .addField('.review-form .input-field__input[name="email"]', [
        {
          rule: Rules.Required,
      ...
      .addField('.review-form .input-field__input[name="message"]', [
        {
          rule: Rules.Required,
